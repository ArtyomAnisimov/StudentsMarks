namespace StudentsMarks
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.студентыTableAdapter = new StudentsMarks.StudentsMarksDataSetTableAdapters.СтудентыTableAdapter();
            ...
            this.студентыBindingSource.DataSource = this.studentsMarksDataSet;
            // 
        ...
        private StudentsMarksDataSetTableAdapters.СтудентыTableAdapter студентыTableAdapter;
